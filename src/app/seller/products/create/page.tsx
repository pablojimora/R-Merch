  ...
  if (user?.role !== 'seller') {
    return (
      <div className="py-12 text-center">
        ...
        <p className="mt-2 text-gray-600">Solo los vendedores pueden crear productos.</p>
      </div>
    );
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        ownerId: user.id, // Agregar el ID del vendedor
      };
  ...
  return (
    <div className="py-8 max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Agrega un nuevo producto a tu catálogo</p>
      </div>
